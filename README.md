...
```
L7  PRESENTATION    felt green + chip red (Open Design)
...
L3  KNOWLEDGE GRAPH Cognee subgraph — scope: poker hands, GTO solutions, ICM, hand histories
L2  VERSIONED HIST  Memoria (v0.4.0) — namespace "pokerhud"
...
```bash
git clone https://github.com/CSOAI-ORG/pokerhud-hive
cd pokerhud-hive
...
`https://pokerhud.ai/.well-known/agent-card.json` — see `agent-card.json`.
